  ...
  return (
    <div className='font-semibold mt-12 md:mt-0  mx-7 md:mx-14 2xl:mx-40 flex justify-center lg:justify-between items-center flex-wrap min-h-[60vh]'>
      <section>
        ...
        <h1 className='text-4xl 2xl:text-6xl'>I&apos;m Yael <span className='block text-colorGreen'>Front End Developer</span> </h1>
        <p className='text-base xl:text-xl lg:w-[400px] xl:w-[700px] my-4 mb-8 leading-7 xl:leading-9 font-semibold'>I&apos;m a specialist in creating attractive and functional interfaces, maintaining your brand identity and optimizing the performance of your website or application to the fullest.</p>
